...
## Refs
  ...
  - Always [create refs](https://reactjs.org/docs/refs-and-the-dom.html#creating-refs) with `React.createRef()`. eslint: [`react/no-string-refs`](https://github.com/yannickcr/eslint-plugin-react/blob/master/docs/rules/no-string-refs.md)
...
## Methods
  ...
  - Bind event handlers for the render method using arrow functions. eslint: [`react/jsx-no-bind`](https://github.com/yannickcr/eslint-plugin-react/blob/master/docs/rules/jsx-no-bind.md)
